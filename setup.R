...
var.names.assets <- c("lgdp", "lres", "ldef", "lass", "lhou")
...
source("~/Thesis/R Code/dataplot.R")
...
source("~/Thesis/R Code/fixing plot(irf) - Double.R")
source("~/Thesis/R Code/fixing plot(irf) - 1 with 2.R")